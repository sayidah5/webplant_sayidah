...
<div class="container mt-5">
    ...
    <form action="/artikel/create" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" placeholder="Masukkan konten artikel"></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="isi" id="isi" class="form-control" rows="5" placeholder="Masukkan konten artikel"></textarea>
        </div>
